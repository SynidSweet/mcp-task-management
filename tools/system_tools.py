...
def register_system_tools(mcp, project_manager: ProjectManager, tool_filter=None):
    """Register system tools with simple pattern"""

    if not tool_filter or tool_filter.should_register_tool("system_set_project_directory"):
        @mcp.tool()
    ...
    if not tool_filter or tool_filter.should_register_tool("system_health_check"):
        @mcp.tool()
    ...
    if not tool_filter or tool_filter.should_register_tool("workflow_load_context"):
        @mcp.tool()
